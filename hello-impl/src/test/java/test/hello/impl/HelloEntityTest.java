...
import test.hello.impl.HelloCommand.Hello;
import test.hello.impl.HelloCommand.UseGreetingMessage;
import test.hello.impl.HelloEvent.GreetingMessageChanged;
